package com.zzh.lib.gridlayout;
...
public class HGridLayout extends ViewGroup {
    ...
    public HGridLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public HGridLayout(Context context, AttributeSet attrs, int defStyleAttr) {
